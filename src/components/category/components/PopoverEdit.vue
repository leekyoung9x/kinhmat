<template>
  <div v-if="isShow">
    ...
    <div class="popover">
      ...
      <div class="category-input-top">
        <div class="category-input-top-left">
          <div class="category-input-item">
            <label for="categoryName">Tên nhà cung cấp</label>
            <input
      ...
      <div class="group-btn">
        <a href="#" @click.prevent="UpdateCategory" class="save-btn btn">Lưu</a>
...
export default {
  ...
  methods: {
    ...
    UpdateCategory () {
      this.axios
        .put('/Categorys/' + this.category.categoryId, this.category)
        .then((res) => {
