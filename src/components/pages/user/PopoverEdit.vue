...
<div v-if="isShow">
  ...
  <popup-warning title="Đóng Form thông tin khách hàng" detail="Bạn chắc chắn muốn đóng form lại chứ ?" classIcon="fas fa-exclamation-circle" :isShow="isShowPopup" :onHidden="HiddenPopup">
